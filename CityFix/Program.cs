...
{
    options.AddPolicy("CityFixClient", policy =>
    {
...
using (var scope = app.Services.CreateScope())
{
    ...
    var adminEmail = "admin@cityfix.com";
    var adminExists = await dbContext.Users.AnyAsync(x => x.Email == adminEmail);
